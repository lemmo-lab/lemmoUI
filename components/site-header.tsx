  ...
  return (
    <header className="sticky top-0 z-20 border-b border-border bg-background/95 backdrop-blur">
      <div className="mx-auto flex h-14 max-w-[1440px] items-center justify-between px-4 lg:px-8">
        <div className="flex items-center gap-8"><a href="/"><Logo /></a><nav className="hidden items-center gap-6 text-sm text-muted-foreground md:flex"><a className="text-foreground" href="/#docs">Docs</a><a href="/#components">Components</a><a href="/#blocks">Blocks</a><a href="/#themes">Themes</a></nav></div>
